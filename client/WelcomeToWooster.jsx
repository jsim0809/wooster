...
function WelcomeToWooster() {
  return (
    <section className="body-section center-spot" id="letters-and-mask">
      ...
      {/* SVG Mask for Horizontal Scanning Animation */}
      <svg id="welcome-animation" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 544 46.125">
        <defs>

          <mask className="o-finish-mask">
            ...
            {/* <rect id="bounding-rectangle" className="cls-4b" x="0.125" y="0.125" width="523" height="45" /> */}
            <g id="o-clipping-group">
              <g className="cls-2b">
        ...
        {/* <image href="./assets/welcome-to-wOoster.png" mask="url(#horizontal-scan-mask)" x="0" y="0" /> */}
        ...
        {/* <image href="./assets/welcome-to-wXoster.png" mask="url(#o-finish-mask)" x="0" y="0" /> */}
      </svg>
